...
const {
  ...
  HUBSPOT_USO_MSP_PORTAL_ID,
  HUBSPOT_USO_MSP_API_TOKEN,
  HUBSPOT_USO_MSP_FORM_ID,
  HUBSPOT_USO_MSP_NEWSLETTER_SUBSCRIPTION_ID,
  HUBSPOT_USO_DIRECT_PORTAL_ID,
  HUBSPOT_USO_DIRECT_API_TOKEN,
  HUBSPOT_USO_DIRECT_FORM_ID,
  HUBSPOT_USO_DIRECT_NEWSLETTER_SUBSCRIPTION_ID,
} = process.env;
